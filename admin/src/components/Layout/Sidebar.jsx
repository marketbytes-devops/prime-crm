...
const Sidebar = ({ toggleSidebar }) => {
  ...
  const menuItems = [
      ...
      subItems: [
        {
          to: "/pre-job/add-rfq",
          label: "Add RFQ",
          icon: <FilePlus className="w-4 h-4 inline-block mr-2" />,
        },
        {
          to: "/pre-job/view-rfq",
          label: "View RFQ",
    ...
    {
      label: "Settings",
      icon: <Settings className="w-4 h-4 inline-block mr-2" />,
      subItems: [
        { to: "/settings/rfq-channel", label: "RFQ Channel", icon: <FileText className="w-4 h-4 inline-block mr-2" /> },
        { to: "/settings/product", label: "Product", icon: <FileText className="w-4 h-4 inline-block mr-2" /> },
        { to: "/settings/item", label: "Item", icon: <FileText className="w-4 h-4 inline-block mr-2" /> },
        { to: "/settings/unit", label: "Unit", icon: <FileText className="w-4 h-4 inline-block mr-2" /> },
        { to: "/settings/team", label: "Team", icon: <FileText className="w-4 h-4 inline-block mr-2" /> },
      ],
    },
  ];
            ...
            <li key={index}>
              {item.subItems ? (
                <>
                  ...
                  <AnimatePresence>
                    {(item.label === "Pre-Job" ? isPreJobOpen : isSettingsOpen) && item.subItems && (
                      <motion.ul
