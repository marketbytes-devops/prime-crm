...
import ClientSelectionModal from '../ClientSelectionModal.jsx';
                          ...
                          {item.subItems.map((subItem, subIndex) => (
                            <li key={subIndex}>
                              <NavLink
                                ...
                                onClick={subItem.onClick || (() => isMobile() && toggleSidebar())}
                              >
                                <span className="flex items-center">
                                  {subItem.icon}
                                  {subItem.label}
